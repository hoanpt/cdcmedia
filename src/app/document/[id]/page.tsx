  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 py-6 sm:py-8 max-w-7xl">
      ...
      <div className="flex justify-between items-center mb-6">
        <Link href="/" className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-50 text-indigo-700 hover:bg-indigo-100 hover:text-indigo-800 rounded-xl text-sm font-bold transition-colors border border-indigo-100/50 shadow-sm">
